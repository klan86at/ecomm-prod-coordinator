...
class FlipkartScrapper:
    ...
    def get_top_reviews(self, product_url, count=2):
        ...
        try:
            ...
            review_blocks = soup.select("din._27M-vq, div.col.EPCmJX, div._6K-7Co")
            seen = set()
            reviews = []
    ...
    def scrape_flipkart_products(self, query, max_products=1, review_counts=2):
        ...
        Args:
            ...
            review_counts (int, optional): _description_. Defaults to 2.
        """
        options = uc.ChromeOptions()
        driver = uc.Chrome(options=options, use_subprocess=True)
        ...
        for item in items:
            ...
            top_reviews = self.get_top_reviews(product_link, count=review_counts) if "flipkart.com" in product_link else "Invalid product URL"
    ...
    def save_to_csv(self, data, filename="product_reviews.csv"):
        """Save the scrapped product reviews to a CSv file.
        Args:
