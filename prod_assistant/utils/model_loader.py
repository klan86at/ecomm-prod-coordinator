...
import asyncio
# 👇 Load .env file BEFORE accessing os.getenv()
load_dotenv()  # This populates os.environ with values from .env

class ApiKeyManager:
    """
    Manages loading and accessing API keys from environment variables or ECS secrets.
    """
    def __init__(self):
        self.api_keys = {
        ...
        for key, val in self.api_keys.items():
            if val:
                ...
                log.warning(f"{key} is missing from env var")
